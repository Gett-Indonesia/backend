...
<div class="main-panel">
        ...
        <!-- partial:partials/_footer.html -->
          ...
          <div class="container-fluid clearfix">
            <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">Copyright © 2019
              <a>Skala Modular Teknologi</a><i class="mdi mdi-heart text-danger"></i>. All rights reserved.</span>
            </span>
          </div>
        </footer>
        <!-- partial -->
