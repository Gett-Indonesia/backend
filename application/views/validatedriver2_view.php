        ...
        <div class="content-wrapper">
              ...
              <div class="card">
				...
				<div class="box-header with-border">
				  ...
				  <div class="row">
                                            <a class="col-md-6 btn btn-primary" href="<?php echo base_url() ?>index.php/Validatedriver/validasiDriver/<?php echo $pendaftar[0]['nomor']; ?>/<?php echo "$tittle";?>" role="button" onclick="return confirm('Are you sure to validate the registration of the driver ?')">Validate</a>
