...
<?php include 'SIDEBAR.php'; ?>
		...
		<div class="col-md-12 ">
										...
										<br><br>
										<div class="row">
                                            <a class="col-md-6 btn btn-primary" href="<?php echo base_url(); ?>index.php/drivertopup/validasiTopup/<?php echo $detailtopup[0]['nomor']; ?>/<?php echo $detailtopup[0]['id_user']; ?>" role="button" onclick="return confirm('Are you sure to do varification with the Topup ?')">Verification</a>
