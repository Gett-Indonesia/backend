...
//                                            var_dump($pendaftar);
                                            ...
                                            $no++ ?></p></td>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url() ?>index.php/Validatedriver/validasiMservice/<?php echo "$d->nomor"; ?>"><button type="button" class="btn btn-primary btn-sm" onclick="return confirm('Are you sure to validate the registration of the driver ?')">Validation</button></a>
