                  ...
                  <div class="table-responsive">
					...
					<tbody>
                                            ...
                                            $no++ ?></p></td>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url() ?>index.php/Validatedriver/validasiDriver/<?php echo "$d->nomor"; ?>/<?php echo "$tittle";?>"><button type="button" class="btn btn-primary btn-sm" onclick="return confirm('Are you sure to validate the registration of the driver ?')">Validasi</button></a>
