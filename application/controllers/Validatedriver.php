...
//        Redirect page ===========
        switch ($tittle) {
            case 'Driver%20Motor':
                $this->pesan = "<p style=\"color:green\" class=\"text-center\">Data Pelamar Berhasil di validasi</p> <br>";
                $this->driverMotor();
                break;
            case 'Car':
                $this->pesan = "<p style=\"color:green\" class=\"text-center\">Data Pelamar Berhasil di validasi</p> <br>";
...
//        echo $idMitra;
        ...
        $this->pesan = "<p style=\"color:green\" class=\"text-center\">Data pendaftaran mitra berhasil di validasi</p> <br>";
        $this->mfood();
    }
...
//                        T O L A K ================================================================================
    public function tolakDriver($idPelamar, $tittle) {
        ...
        switch ($tittle) {
            case 'Driver%20Motor':
                $this->pesan = "<p style=\"color:green\" class=\"text-center\">Data Pelamar Berhasil di tolak</p> <br>";
                $this->driverMotor();
                break;
            case 'Car':
                $this->pesan = "<p style=\"color:green\" class=\"text-center\">Data Pelamar Berhasil di tolak</p> <br>";
...
//        echo "$alasan | $idmitra | $idresto";
        ...
        $this->pesan = "<p style=\"color:green\" class=\"text-center\">Data Pendaftar Food Berhasil di tolak</p> <br>";
        $this->mfood();
    }
...
//        $this->email->initialize($config);
        ...
        $this->email->subject('[Gorideme.fun] Validasi Berkas Pendaftaran ');
        $this->email->message("
            <html>
            <head>
            <title>Berkas Pendaftaran anda telah di Validasi oleh Admin</title>
            </head>
            <body>
            <p>Terimakasih telah mendaftarkan diri anda sebagai mitra dari Gorideme.fun. data pendaftaran anda telah di validasi oleh pihak admin Gorideme, silakan hubungi kami untuk melakukan konfirmasi.</p>
...
//        $this->email->initialize($config);
        ...
        $this->email->message("
            <html>
            <head>
            <title>Pendaftaran Food anda telah divalidasi oleh admin</title>
            </head>
            <body>
            <p>Terimakasih telah melakukan pendaftaran. Pendaftaran anda telah divalidasi oleh admin. Silakan kunjungi <a href='https://gorideme.fun/vendor/'>https://gorideme.fun/vendor/</a> dan melakukan login menggunakan Email dan Password yang telah anda daftarkan</p>
            <br><br><br>
