...
//        echo "status = $status | idmitra = $idmitra | id resto = $idresto";
        ...
        if ($status == 3) {
            $this->pesan = "<p style=\"color:green\" class=\"text-center\">Status Mitra Berhasil di Delete</p> <br>";
            $this->index();
        } else if ($status == 2) {
            $this->pesan = "<p style=\"color:green\" class=\"text-center\">Status Mitra Berhasil di Non Aktifkan</p> <br>";
            $this->index();
        } else {
            $this->pesan = "<p style=\"color:green\" class=\"text-center\">Status Mitra Berhasil di Aktifkan</p> <br>";
            $this->index();
        }
