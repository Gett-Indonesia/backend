...
class Bannermfood extends CI_Controller {
    ...
    public function turnoff($id) {
        ...
        $this->pesan = "<p style=\"color:green\" class=\"text-center\">Banner Berhasil di Nonaktifkan</p> <br>";
        $this->index();
    }
...
//        hapus file 
        ...
        if (unlink("$path")) {
            ...
            $this->pesan = "<p style=\"color:green\" class=\"text-center\">Data Banner Food berhasil di hapus</p> <br>";
            $this->index();
        } else {
            $this->pesan = "<p style=\"color:red\" class=\"text-center\">Data Promosi gagal hapus, mohon contact Admin</p> <br>";
            $this->index();
        }
    }
    ...
    public function tambahBannerMfood() {
        ...
        if ($idresDB == NULL) {
            $this->pesan = "<p style=\"color:red\" class=\"text-center\">Restoran Tidak Ditemukan</p> <br>";
            $this->index();
        } else {
...
//            echo "$nama | $kategori | $harga | $deskripsi | $new_name";
                $this->pesan = "<p style=\"color:green\" class=\"text-center\">Banner Promosi berhasil di tambahkan</p> <br>";
                $this->index();
            } else {
                $this->pesan = "<p style=\"color:red\" class=\"text-center\">Lengkapi persyaratan</p> <br>";
                $this->index();
            }
        }
    }
