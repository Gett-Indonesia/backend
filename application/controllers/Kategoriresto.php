...
//        $pathfiledelete = $_SERVER['DOCUMENT_ROOT'] . "/admin/fotokategoriresto/$namafoto";
        ...
        $this->pesan = "<p style=\"color:green\" class=\"text-center\">Kategori Berhasil di tambah</p> <br>";
        $this->index();
    }
...
//        echo "$kategori | $namafotobaru | $namafotolama";
        ...
        if ($_FILES["userfile"]['name'] != NULL) {
            ...
            $this->pesan = "<p style=\"color:green\" class=\"text-center\">Kategori Berhasil diedit</p> <br>";
            $this->index();
        } else {
            // Update database
            $this->load->model('Kategoriresto_m');
