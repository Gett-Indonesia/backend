...
class Layananpijat extends CI_Controller {
    ...
    public function insertLayanan() {
        ...
        $this->pesan = "<p style=\"color:green\" class=\"text-center\">Layanan Berhasil di tambah</p> <br>";
        $this->index();
    }
...
//        hapus file 
        ...
        if (unlink("$pathfiledelete")) {
            ...
            $this->pesan = "<p style=\"color:green\" class=\"text-center\">Data berhasil di hapus</p> <br>";
            $this->index();
        } else {
