...
//            echo "$nama | $kategori | $harga | $deskripsi | $new_name";
            ...
            $this->pesan = "<p style=\"color:red\" class=\"text-center\">Foto yang anda upload tidak sesuai persyaratan</p> <br>";
            $this->index();
        }
    }
...
//        hapus file 
        ...
        if (unlink("$path")) {
            ...
            $this->pesan = "<p style=\"color:green\" class=\"text-center\">Data Promosi berhasil di hapus</p> <br>";
            $this->index();
        } else {
