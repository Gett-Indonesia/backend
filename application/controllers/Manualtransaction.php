...
//        echo "$id | $saldo + $penambahan";
        ...
        if ($pengurangan > $saldo) {
            $this->pesan = "<p style=\"color:red\" class=\"text-center\">Pengurangan melebihi batas saldo saat ini Rp $saldo</p> <br>";
            $this->Pelanggan();
        } else {
            ...
            $this->pesan = "<p style=\"color:green\" class=\"text-center\">Pengurangan saldo berhasil saldo menjadi Rp $saldoakhir</p> <br>";
            $this->Pelanggan();
        }
    }
...
//        echo "$id | $saldo + $penambahan";
        ...
        //pesan sukses + redirect ke halaman pelanggan 
        $this->pesan = "<p style=\"color:green\" class=\"text-center\">Penambahan saldo berhasil saldo menjadi Rp $saldoakhir</p> <br>";
        $this->Pelanggan();
    }
